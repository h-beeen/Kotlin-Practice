...
import com.ggsdh.backend.global.exception.ApiExceptionHandlingFilter
import com.ggsdh.backend.global.security.filter.JwtAuthFilter
import com.ggsdh.backend.global.security.matcher.CustomRequestMatcher
...
class SecurityConfig(
    ...
    fun tempUserFilterChain(http: HttpSecurity): SecurityFilterChain {
        http.authorizeRequests { auth ->
            auth.requestMatchers(customRequestMatcher.tempUserEndpoints()).hasRole("TEMP_USER").anyRequest()
                .hasRole("USER")
        }
